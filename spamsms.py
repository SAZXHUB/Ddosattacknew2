 ...
 `mo/-:+ymMm                mMms+:-/om`
  .h/+/y`hhs                yyh`y/+/h.
   `hd/::-+.                .+-::/dy`
	...
	print(Fore.RED+"หากเครื่องมือขึ้นความผิดปกติ ไม่ต้องไปสนใจมันนะครับมันยังคงทำงานต่อไป")
	print(" วิธีใช้ python3 spamsms.py (เลขเบอร์โทรที่จะสแปม) (จำนวนข้อความที่จะส่ง)" )
